         ...
         <div className="container-fluid">
            <div className={`row ${styles.desktop}`}>
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice1.png"
                     width={0}
                     height={0}
                     sizes="100vw"
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice2_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice3.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice4_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice5.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice6_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice7.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/slice8_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
            ...
            <div className={`row ${styles.mobile}`}>
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice1mob.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice2mob_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice3mob_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice4mob_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice5mob_btn.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
               ...
               <div className={styles.block}>
                  <Image
                     src="/img/forum/event-2024-05-16/mob/slice6mob.png"
                     width={0}
                     height={0}
                     sizes="100vw"
                     style={{width: '100%', height: 'auto'}}
